...
| G3 行与卡 | Row · RowDetail · Card · InfoCard · **Section** · **Field** · **Kv** · ThinTable · **RefPill**（+ **AnTwoZone** 右锚两区 · **AnAutoGrid** 响应式块网格 · **AnEditableValue** 双锚编辑核 · **AnSeamlessField** 编辑字段叶子 共享原语） | ⏳（G3.1–G3.8 已落:AnTwoZone · 地基增强 · RefPill · Section · AutoGrid · EditableValue · Kv · Field） |
