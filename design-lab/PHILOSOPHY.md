...
- **圆角浮窗 + 海与岛**：整窗是浮在桌面的圆角窗（窗内底 = 海，浅灰）。
  **中间主区 = 海**（平铺，对话直接铺在海上、无白卡）；**侧栏、右侧面板 = 岛**
  （圆角白面板浮在海上，8px 窄缝、12px 圆角、发丝边、柔阴影）；composer 的 git 条 /
  输入框 / 用户气泡也是浮在海上的**小岛**。这正是 Claude Code 的做法——
  别把主区也做成白岛（那样就没有海了），也别走另一极端做成齐边方块（那样就没有岛了）。
