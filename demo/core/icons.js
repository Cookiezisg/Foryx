/* Forgify demo — 共享图标集（线性描边，1.6–1.7 stroke）。
   ⚠ APPEND-ONLY（防撞铁律）：新增只「加 key」；永不改名/删已有 key。用法：icon('chat', 16) → SVG 字符串。 */
window.ICONS = {
  ...
  scheduler:'<circle cx="12" cy="12" r="9"/><path d="M12 7.5V12l3 1.8"/>',
  ...
  function:'<path d="M8 3.5c-2 0-2 3-2 4.2 0 1.1-1 2.3-2 2.3 1 0 2 1.2 2 2.3 0 1.2 0 4.2 2 4.2M16 3.5c2 0 2 3 2 4.2 0 1.1 1 2.3 2 2.3-1 0-2 1.2-2 2.3 0 1.2 0 4.2-2 4.2"/>',
  handler:'<rect x="4" y="4" width="16" height="7" rx="2"/><rect x="4" y="13" width="16" height="7" rx="2"/><path d="M7.5 7.5h.01M7.5 16.5h.01"/>',
  workflow:'<circle cx="6" cy="6" r="2.4"/><circle cx="18" cy="6" r="2.4"/><circle cx="12" cy="18" r="2.4"/><path d="M8 7.4 10.6 15.8M16 7.4 13.4 15.8M8.4 6h7.2"/>',
  trigger:'<circle cx="12" cy="12" r="2.3"/><path d="M6.6 6.6a8 8 0 0 0 0 10.8M17.4 6.6a8 8 0 0 1 0 10.8M3.8 3.8a12 12 0 0 0 0 16.4M20.2 3.8a12 12 0 0 1 0 16.4"/>',
  control:'<circle cx="5" cy="12" r="2"/><circle cx="19" cy="6" r="2"/><circle cx="19" cy="18" r="2"/><path d="M7 12h3.5l4.5-5M10.5 12l4.5 5"/>',
  action:'<rect x="3" y="3" width="18" height="18" rx="4.5"/><path d="m10 8.4 5.6 3.6L10 15.6z"/>',
  shield:'<path d="M12 3 5 6v5.5c0 4 3 6.8 7 8 4-1.2 7-4 7-8V6z"/>',
  ...
  table:'<rect x="3" y="5" width="18" height="14" rx="1.5"/><path d="M3 10.5h18M9 5v14"/>',
  image:'<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.6"/><path d="m4.5 18 4.5-4 3.5 2.5L17 11l3 3.5"/>',
  ...
  mcp:'<rect x="6" y="7" width="12" height="8" rx="2.5"/><path d="M10 7V3.5M14 7V3.5"/><path d="M12 15v2.5a3 3 0 0 0 3 3h2.5"/>',
  skill:'<rect x="5" y="4" width="14" height="16" rx="2"/><path d="M9 4v16"/><path d="M12.5 9.5h3.5M12.5 13.5h3.5"/>',
};
