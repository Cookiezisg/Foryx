...
func New(deps Deps) http.Handler {
	...
	if deps.Dev {
		handlershttpapi.NewDevHandler(deps.DB, deps.LogBroadcaster, deps.IntegrationDir, deps.ForgifyHome, deps.Port, deps.Tools, deps.LLMFactory, deps.ShellManager, deps.Log, NewRecorderAdapter(rec)).Register(rec)
